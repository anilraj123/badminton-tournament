...
//   MD-B  VIVIN JOY & Sojan PR v Reebu Kurian & John Philip
...
//
// LATE SUBSTITUTION (2026-09-05, tournament morning): MD Group B's
// 'Reebu Kurian & Noah Paul' is now 'Reebu Kurian & John Philip' -- Noah Paul
// withdrew. The sheet still lists Noah Paul; the site is deliberately ahead of
// it. Affects 5 group matches. Re-apply if this file is regenerated.
//
...
const ROWS = [
  ...
  [57, '10:45', 16, 'MD', 'Group B', 'DEEPAK LAL & NISHANT GEORGE', 'Reebu Kurian & John Philip'],
  ...
  [78, '11:30', 13, 'MD', 'Group B', 'Reebu Kurian & John Philip', 'Allen Paul & Biju Varghese'],
  ...
  [102, '12:15', 13, 'MD', 'Group B', 'Reebu Kurian & John Philip', 'Binu John & Aju Philip'],
  ...
  [117, '12:45', 11, 'MD', 'Group B', 'VIVIN JOY & Sojan PR', 'Reebu Kurian & John Philip'],
  ...
  [128, '13:15', 12, 'MD', 'Group B', 'George Kandathil & Kayson Neduvakkattu', 'Reebu Kurian & John Philip'],
...
export const TEAM_ROSTERS = {
  ...
  'Reebu Kurian & John Philip': ['Reebu Kurian', 'John Philip'],
